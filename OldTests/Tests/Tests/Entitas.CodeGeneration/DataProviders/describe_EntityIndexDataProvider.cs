...
class describe_EntityIndexDataProvider : nspec {
    ...
    void when_providing() {
        ...
        it["creates data for single entity index"] = () => {
            ...
            d.GetEntityIndexName().ShouldBe("MyNamespaceEntityIndex");
        ...
        it["creates data for multiple entity index"] = () => {
            ...
            data[0].GetEntityIndexName().ShouldBe("MyNamespaceMultipleEntityIndices");
            data[0].GetHasMultiple().ShouldBeTrue();

            data[1].GetEntityIndexName().ShouldBe("MyNamespaceMultipleEntityIndices");
