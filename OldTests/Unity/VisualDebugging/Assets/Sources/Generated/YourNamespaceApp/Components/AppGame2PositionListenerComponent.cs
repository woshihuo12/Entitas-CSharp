...
namespace YourNamespace {
    public partial class AppEntity {
        ...
        public Game2PositionListenerComponent game2PositionListener { get { return (Game2PositionListenerComponent)GetComponent(YourNamespace.AppComponentsLookup.Game2PositionListener); } }
        public bool hasGame2PositionListener { get { return HasComponent(YourNamespace.AppComponentsLookup.Game2PositionListener); } }

        public void AddGame2PositionListener(System.Collections.Generic.List<IGame2PositionListener> newValue) {
            var index = YourNamespace.AppComponentsLookup.Game2PositionListener;
        ...
        public void RemoveGame2PositionListener() {
            RemoveComponent(YourNamespace.AppComponentsLookup.Game2PositionListener);
        }
    }
}
        ...
        public static Entitas.IMatcher<AppEntity> Game2PositionListener {
            get {
                if (_matcherGame2PositionListener == null) {
                    var matcher = (Entitas.Matcher<AppEntity>)Entitas.Matcher<AppEntity>.AllOf(YourNamespace.AppComponentsLookup.Game2PositionListener);
