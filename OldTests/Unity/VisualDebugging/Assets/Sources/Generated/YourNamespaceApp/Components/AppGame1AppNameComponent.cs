...
namespace YourNamespace {
    public partial class AppEntity {
        ...
        public Game1.AppNameComponent game1AppName { get { return (Game1.AppNameComponent)GetComponent(YourNamespace.AppComponentsLookup.Game1AppName); } }
        public bool hasGame1AppName { get { return HasComponent(YourNamespace.AppComponentsLookup.Game1AppName); } }

        public void AddGame1AppName(string newValue) {
            var index = YourNamespace.AppComponentsLookup.Game1AppName;
        ...
        public void RemoveGame1AppName() {
            RemoveComponent(YourNamespace.AppComponentsLookup.Game1AppName);
        }
    }
}
        ...
        public static Entitas.IMatcher<AppEntity> Game1AppName {
            get {
                if (_matcherGame1AppName == null) {
                    var matcher = (Entitas.Matcher<AppEntity>)Entitas.Matcher<AppEntity>.AllOf(YourNamespace.AppComponentsLookup.Game1AppName);
